import { type AnyTable, type InferModelFromColumns, Table } from "drizzle-orm/table";
import { type AnyColumn, Column } from "drizzle-orm/column";
import { entityKind } from "drizzle-orm/entity";
import { and, asc, between, desc, exists, ilike, inArray, isNotNull, isNull, like, not, notBetween, notExists, notIlike, notInArray, notLike, or } from "drizzle-orm/sql/expressions";
import { type Placeholder, SQL, sql } from "drizzle-orm/sql/sql";
import type { Assume, ColumnsWithTable, Equal, Simplify, ValueOrArray } from "drizzle-orm/utils";
...
export declare function getOperators(): {
    ...
    eq: import("drizzle-orm/expressions").BinaryOperator;
    exists: typeof exists;
    gt: import("drizzle-orm/expressions").BinaryOperator;
    gte: import("drizzle-orm/expressions").BinaryOperator;
    ilike: typeof ilike;
    inArray: typeof inArray;
    isNull: typeof isNull;
    isNotNull: typeof isNotNull;
    like: typeof like;
    lt: import("drizzle-orm/expressions").BinaryOperator;
    lte: import("drizzle-orm/expressions").BinaryOperator;
    ne: import("drizzle-orm/expressions").BinaryOperator;
    not: typeof not;
