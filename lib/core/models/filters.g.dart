...
_Filters _$FiltersFromJson(Map<String, dynamic> json) => _Filters(
  status:
      $enumDecodeNullable(_$FilterLoadStatusEnumMap, json['status']) ??
      FilterLoadStatus.initial,
  blockedAccounts:
      (json['blockedAccounts'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
  hidedPosts:
      (json['hidedPosts'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
  hidedAllPostsAccounts:
      (json['hidedAllPostsAccounts'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
);
