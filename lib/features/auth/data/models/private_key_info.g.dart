...
_PrivateKeyInfo _$PrivateKeyInfoFromJson(Map<String, dynamic> json) =>
    _PrivateKeyInfo(
...
Map<String, dynamic> _$PrivateKeyInfoToJson(_PrivateKeyInfo instance) =>
    <String, dynamic>{
...
_PrivateKeyTypeInfo _$PrivateKeyTypeInfoFromJson(Map<String, dynamic> json) =>
    _PrivateKeyTypeInfo(
...
Map<String, dynamic> _$PrivateKeyTypeInfoToJson(_PrivateKeyTypeInfo instance) =>
    <String, dynamic>{
