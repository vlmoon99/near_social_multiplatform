...
class LoginBody extends StatefulWidget {
  const LoginBody({
    super.key,
    required this.nearWalletSelectorWidgetController,
  });

  final NearWalletSelectorWidgetController nearWalletSelectorWidgetController;
              ...
              CustomButton(
                ...
                onPressed: () async {
                  if (kIsWeb) {
                    ...
                    widget.nearWalletSelectorWidgetController.toggleSelector();
                  }
                },
                child: const Text(
                  "Login with Wallet",
